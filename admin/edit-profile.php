...
?>
  ...
  <li class="Active"><i class="fa fa-folder-user"></i>   EDIT PROFILE </li>
   ...
   <div class="row">
       ...
       <div class="form-group">
           ...
           <input type="file"  id="image" name="image" >
                    ...
                    <div class="form-group">
                     ...
                     <input type="submit" value="Update Profile" name="submit" class="btn btn-danger">
       ...
       <div class="col-md-4">
          <?php
             ...
             echo "<img src='imgg/$e_image' width='300px' class='img-circle img-thumbnail' >"  ;
